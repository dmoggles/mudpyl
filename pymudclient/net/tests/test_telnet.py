...
from pymudclient.net.telnet import TelnetClient, ECHO
from pymudclient.net.mccp import COMPRESS2
...
from pymudclient.colours import fg_code, RED, WHITE, BLACK, bg_code
