...
from pymudclient.mudconnect import main
...
class Test_Main:
    ...
    @patch("pymudclient.mudconnect", "parser")
    @patch("pymudclient.mudconnect", "load_file")
    @patch("pymudclient.gui.gtkgui", "configure", Mock())
